          ...
          onPress: async () => {
            ...
            try {
              const locationData = JSON.parse(
                (await SecureStore.getItemAsync(LAST_LOCATION_TOKEN)) || "{}",
              );
              ...
              Alert.alert(
                "Error",
                "Failed to send SOS message. Please try again.",
              );
            }
          },
        },
      ...
      >
        ...
        >
          ...
          <TouchableOpacity
            ...
            accessibilityHint={
              isTracking
                ? "Double tap to stop sharing your location with caretakers"
                : "Double tap to start sharing your location with caretakers"
            }
          >
            <Ionicons
        ...
        >
          ...
          userDetails.connectedUsers.length > 0 ? (
            ...
            >
              ...
              >
                Add a caretaker to help monitor your location and provide
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Share this code with your caretakers to connect with them. They
              can scan it using their camera.
            </Text>
